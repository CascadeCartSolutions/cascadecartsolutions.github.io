describe("", function() {
  ...
  beforeEach(function() {
    ...
    browser.get("examples/example-location-hashbang-mode/dashboard.html");
  });
  
  var addressBar = element(by.css("#addressBar")),
       url = 'http://www.example.com/base/dashboard.html#!/path?a=b#h';
  ...
  it("should change $location accordingly", function(){
    ...
    expect(addressBar.getAttribute('value')).toBe("http://www.example.com/base/dashboard.html#!/first?a=b");
    ...
    expect(addressBar.getAttribute('value')).toBe("http://www.example.com/base/dashboard.html#!/sec/ond?flag#hash");
